...
image: '../../assets/images/terminal-de-colores.png'
author: 'edicsonabel'
...
![Consola CMD o simbolo del sistema](../../assets/images/consola-cmd-simbolo-del-sistema.webp)
...
![Menu de discos duros en instalación de windows](../../assets/images/menu-de-discos-duros-instalacion-de-windows.webp)

Luego debemos pulsar las teclas `SHIFT+F10` para que se abra la consola.

![Consola CMD o simbolo del sistema en instalación de windows](../../assets/images/consola-cmd-simbolo-del-sistema-instalacion-de-windows.webp)
